...
@objc open class PeekView: UIView {
     ...
     */
    @objc open class func viewForController(parentViewController: UIViewController, contentViewController: UIViewController, expectedContentViewFrame: CGRect, fromGesture: UILongPressGestureRecognizer, shouldHideStatusBar: Bool, menuOptions: NSArray?, completionHandler: ((Int) -> Void)?, dismissHandler: (() -> Void)?) {
        ...
        PeekView().viewForController(parentViewController: parentViewController, contentViewController: contentViewController, expectedContentViewFrame: expectedContentViewFrame, fromGesture: fromGesture, shouldHideStatusBar: shouldHideStatusBar, menuOptions: options, completionHandler: completionHandler, dismissHandler: dismissHandler)
    }
    
    open func viewForController(parentViewController: UIViewController, contentViewController: UIViewController, expectedContentViewFrame: CGRect, fromGesture: UILongPressGestureRecognizer, shouldHideStatusBar: Bool, menuOptions: [PeekViewAction]? = nil, completionHandler: ((Int) -> Void)? = nil, dismissHandler: (() -> Void)? = nil) {
        ...
        case .began:
            ...
            peekView.configureView(viewController: contentViewController, subviewFrame: expectedContentViewFrame, shouldHideStatusBar: shouldHideStatusBar, options: menuOptions, completionHandler: completionHandler, dismissHandler: dismissHandler)
